...
<head>
    <?php
    $data['page_title'] = 'Kelola Asisten - SIMLAB';
...
<body>
                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <button type="button" class="btn btn-success" style="margin:4.5pt" data-toggle="modal" data-target="#tambahAsisten">Tambah</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="box-title">Daftar Asisten </h4>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php $i = 0; ?>
                                        <?php foreach ($asisten->result() as $a) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-sm-flex justify-content-between"><a href="javascript:;" data-toggle="modal" data-target="#editAsisten" data-id="<?php echo $a->id; ?>" data-nama="<?php echo $a->nama; ?>" data-prodi="<?php echo $a->prodi; ?>">
                                                            <i class="fa fa-pencil fa-lg" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="<?php echo site_url("Laboran_controller/hapusAsisten/$a->id"); ?>">
    ...
    <div class="modal fade" id="tambahAsisten" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Tambah Asisten</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <?php echo form_open('Laboran_controller/tambahAsisten'); ?>
    ...
    <!-- modal edit asisten -->
    <div class="modal fade" id="editAsisten" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Edit Asisten</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <?php echo form_open('Laboran_controller/editAsisten'); ?>
                    <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            $("#editAsisten").on("shown.bs.modal", function(event) {
