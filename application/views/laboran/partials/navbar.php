    ...
    <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="menu-icon fa fa-area-chart"></i><a href="charts-flot.html">Presensi</a></li>
                    <li><i class="menu-icon fa fa-area-chart"></i><a href="charts-flot.html">Bukti Pembayaran</a></li>
                </ul>
            </li>
