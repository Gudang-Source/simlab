        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Asistensi</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo site_url('praktikan/index'); ?>">Nilai</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Latihan</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Modul</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Jadwal Praktikum</a></li>
                        </ul>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
